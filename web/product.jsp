<%-- 
    Document   : product
    Created on : Aug 6, 2022, 8:07:41 PM
    Author     : ADMIN
--%>
            ...
            <header class="header_section">
                <div class="top-page">
                    <div class="top_page_group">
                        <div class="top_info"><span onclick="pcsh1()" >Tải ứng dụng</span>
                        ...
                        <div  class="top_info"><span > <a style="text-decoration: none; color: white;" href="https://help.sendo.vn/hc/vi">Chăm sóc khách hàng</a> </span>
                        </div>
                        <div class="top_info"><span onclick="pcsh2()" >Kiểm tra đơn hàng</span>
    ...
    <c:set value="${requestScope.PRODUCT}" var="p" ></c:set>
        <div class="main_body">
            <div class="category_product">
                <a  href="">${p.categoryID}</a>
        </div>
        <div class="main-product">
            <div class="image_product">
                <img class="img_big_product" width="600px" height="450px" src="${p.image}"/>
            </div>
            <div class="detail_big_product">
                <span class="detail_name_product">${p.productName}</span><br>
                <span class="detail_main_price">${p.price}đ</span><br>			
                <!--          <div class="box_quantity">
                            <span>Chọn số lượng:</span>
                            <button onclick="this.parentNode.querySelector('.box_quantity_input').stepDown()" class="box_quantity_sub">-</button>
                            <input class="box_quantity_input" min="1" name="quantity" value="1" type="number"/>
                            <button onclick="this.parentNode.querySelector('.box_quantity_input').stepUp()" class="box_quantity_plus">+</button>
                          </div>-->
                <div class="btn-product">
                    <button class="btn_add_to_cart">
                        <a href="MainController?action=addToCart&productID=${p.productID}" style="text-decoration: none; color: black; font-weight:bold">Thêm vào giỏ hàng</a>
                    </button>
                    <button class="buy_now"><a href="AddToCartController1?productID=${p.productID}"style="text-decoration: none; color: white;font-weight:bold">
                            Mua ngay
                        </a></button>
        ...
        <div class="detail_sub_product">
            <div class="info_big_product">
                <span class="decription_product">Mô tả sản phẩm</span><br>
                <span class="detail_decription">${p.description}</span>
            </div>
        </div>
    </div>
</div>
